...
namespace eShopSolutions.Application.Catalog.Products
{
    public class ManageProductService : IManageProductService
    {
        ...
        public async Task<int> Update(ProductUpdateRequest request)
        {
            ...
            if (product == null || productTranslations == null) throw new EShopException($"cant find a prodcut with id: {request.Id}");
        ...
        {
            var product = await _context.Products.FindAsync(productId);
            if (product == null) throw new EShopException($"cant find a prodcut with id: {productId}");
        ...
        public async Task<ProductViewModel> GetById(int productId, string languageId)
        {
            ...
            var productViewModel = new ProductViewModel()
            {
                ...
                Name = productTranslation.Name != null ? productTranslation.Name : null,
